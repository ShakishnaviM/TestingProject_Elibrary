...
public class CheckRequiredtype {
    ...
    public Object[][] provideUserData() {
        return new Object[][] {
            {"1234", "V@gmail.com", "12345","1", "1"}, // Give only the numbers for the name
            {"vishaka", "v@@Gmail.com", "12345", "1", "1"}, //enter a invalid email type
            {"vishaka", "V@gmail.com", "123EEy^&!", "1", "1"}, // Provide the all in the correct format 
