...
public class CheckingRequiredFieleds {
    ...
    public void TC1() throws InterruptedException {
        ...
        driver.findElement(By.id("category_name")).sendKeys("");  // Leave it empty
    ...
    // Add category with empty status
    @Test
    public void TC2() throws InterruptedException {
        driver.findElement(By.id("category_name")).clear();
        driver.findElement(By.id("category_name")).sendKeys("Novel");

        
        driver.findElement(By.id("status")).click();  // Leave it empty
